        ...
        try:
            ...
            if date and time:
                ...
                <body>
                    ...
                    <div class='content'>
                        <p>Greetings,</p>
                        <p>We would like to inform you that there is a scheduled power interruption around <span class='important-text'>{locations[i].upper()}</span> on <span class='important-text'>{date}</span>.</p>
                ...
                <body>
                    ...
                    <div class='content'>
                        <p>Greetings,</p>
                        <p>Good news! There is no planned power interruption around <span class='important-text'>{locations[i].upper()}</span> for the next two weeks.</p>
